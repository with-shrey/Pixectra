...
public class InstaMain extends Activity implements OnClickListener {
	...
	private Handler handler = new Handler(new Callback() {
		...
		public boolean handleMessage(Message msg) {
			if (msg.what == InstagramApp.WHAT_FINALIZE) {
				...
				Toast.makeText(InstaMain.this, "Check your network.",
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.main_insta);
		...
		mApp.setListener( new InstagramApp.OAuthAuthenticationListener() {
			...
			public void onFail(String error) {
				Toast.makeText(InstaMain.this, error, Toast.LENGTH_SHORT)
						.show();
			}
		});
		setWidgetReference();
	...
	public void onClick(View v) {
		if (v == btnConnect) {
			...
			startActivity(new Intent(InstaMain.this, AllMediaFiles.class)
			...
			startActivity(new Intent(InstaMain.this, Relationship.class)
